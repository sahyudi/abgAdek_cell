...
class M_report extends CI_Model
{
    ...
    function get_penjualan($fromDate = null, $toDate = null, $item_id = null, $outlet = null)
    {
        ...
        $this->db->where("a.tanggal BETWEEN '{$fromDate}' AND '{$toDate}'");
        if ($item_id != 0) {
            $this->db->where('A.aksesoris_id', $item_id);
        }
